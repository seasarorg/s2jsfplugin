...
public class TagDefinition {
	...
	/**
	 * タグ情報をjava.util.Listで取得します。
	 * 
	 * @return 全てのTagInfoを格納したList
	 */
	...
	/**
	 * タグ情報の初期化を行います。
	 * 本当はDTDから読み込むようにしたいけど、DTDParserがHTMLのDTDをパースできないんだよね。。。
	 */
	static {
		...
		TagInfo area = new TagInfo("area",false);
		...
		TagInfo br = new TagInfo("br",false);
		...
		TagInfo col = new TagInfo("col",true);
...
//		form.addAttributeInfo(new AttributeInfo("onblur",true));
		...
		TagInfo frame = new TagInfo("frame",true);
		...
		TagInfo hr = new TagInfo("hr",true);
		...
		TagInfo img = new TagInfo("img",false);
		...
		TagInfo input = new TagInfo("input",true);
		...
		TagInfo isindex = new TagInfo("isindex",false);
		...
		TagInfo link = new TagInfo("link",true);
		...
		TagInfo meta = new TagInfo("meta",false);
		...
		TagInfo param = new TagInfo("param",true);
